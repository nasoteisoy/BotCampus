  ...
  var heroImg = loadImg('./art/player.png?v=opt6c');
  var heroImg2 = loadImg('./art/player_f2.png?v=opt6c');
  var blobImg = loadImg('./art/enemy_blob.png?v=opt6c');
  var blobAlt = loadImg('./art/enemy_blob_alt.png?v=opt6c');
